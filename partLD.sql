...
CREATE or replace TABLE part (
    dw_part_shk         BINARY (40) not null,  
    dw_hash_diff        BINARY (40) not null,  
    dw_version_ts       TIMESTAMP not null,    
...
begin
    ...
    (
        ...
        (
            ...
            -- as there is no reason to process each individual change in the record, the last one would have the most recent 
            select
                *
            from
                l_stg s
